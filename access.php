  ...
  <body>
    ...
    <nav class="navbar">
      <div class="logo_item">
        ...
        <img src="img/img1.jpg" width="100" height="100" alt=""></i>
      </div>
      ...
      <div class="navbar_content">
        ...
        <img src="img/img1.jpg" width="100" height="100" alt="" class="profile" />
      </div>
    </nav>
        ...
        <ul class="menu_items">
          ...
          <li class="item">
            <div href="#" class="nav_link submenu_item">
              ...
              <span class="navlink">Solicitud de Crédito</span>
              <i class="bx bx-chevron-right arrow-left"></i>
            </div>

            <ul class="menu_items submenu">
              <a href="code/asoc/solicitar.php" class="nav_link sublink">Generar Solicitud</a>
            </ul>
          </li>
