...
<body>
    ...
    <header class="header">
        ...
        <h1 class="title">SOLICITUD DE CRÃ‰DITO</h1>
        ...
        <form action="agregarSolicitud.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="seccion">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <label for="cedula_aso" class="form-label">CÃ©dula No.</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="direccion_aso" class="form-label">DirecciÃ³n</label>
                ...
                <!-- MÃ¡s campos de datos personales -->

                <div class="row mt-3">

                    <div class="col-md-3">

                        <label for="fecha_exp_doc_aso" class="form-label">Fecha expediciÃ³n</label>
                    ...
                    <div class="col-md-3">
                        ...
                        <label for="pais_exp_cedula_aso" class="form-label">PaÃ­s expediciÃ³n</label>
                    ...
                    <div class="col-md-3">
                        ...
                        <label for="dpto_exp_cedula_aso" class="form-label">Departamento expediciÃ³n</label>
                    ...
                    <div class="col-md-3">
                        ...
                        <label for="ciudad_exp_cedula_aso" class="form-label">Ciudad expediciÃ³n</label>
                ...
                <!-- ContinÃºa con el resto de campos... -->
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-3">
                            ...
                            <label for="anti_emp_sol">* AntigÃ¼edad en aÃ±os</label>
                        ...
                        <div class="col-12 col-sm-3">
                            ...
                            <label for="anti_emp_sol">* AntigÃ¼edad en Meses</label>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-3">
                            ...
                            <label for="area_trabajo_sol">* Ãrea Trabajo</label>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-2">
                            ...
                            <label for="pension_sol">* PensiÃ³n</label>
            ...
            <div class="seccion">
                ...
                <div id="inmuebles-wrapper">
                    ...
                    <!-- AquÃ­ se agregan dinÃ¡micamente los bloques -->
            ...
            <div class="seccion">
                ...
                <h3 class="subtitulo">RELACIÃ“N VEHÃCULOS</h3>
                ...
                <button type="button" class="btn btn-success mt-2" onclick="agregarVehiculo()">Agregar VehÃ­culo</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-3">
                            ...
                            <select name="fami_parent_1_sol" class="form-control" id="fami_parent_1_sol" required>
                                ...
                                <option value="CUÃ‘ADO">CUÃ‘ADO (A)</option>
  ...
  // CRUCIAL: Restaurar archivos al input antes del envío
    ...
    for (const key in solicitud) { // 1. Recorre todas las propiedades del objeto 'solicitud'
        ...
        cedulaInput.addEventListener('blur', function() {
            ...
            const cedula_aso = cedulaInput.value.trim(); // Obtener la cÃ©dula que el usuario estÃ¡ escribiendo
            ...
            xhr.onload = function() {
                ...
                if (xhr.status === 200) {
                    ...
                    try {
                        ...
                        // Verifica si hay un error o la respuesta estÃ¡ vacÃ­a
                        ...
                        // Verifica de dÃ³nde proviene la respuesta
                        ...
                        if (data.from === 'solicitudes') {
                            ...
                            llenarCampos(data); // AquÃ­ pasas el objeto completo
