...
// Activar errores para depuraciÃ³n de subida de archivos
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // DEBUG: InformaciÃ³n sobre archivos recibidos
    ...
    if (isset($_FILES['archivos'])) {
        ...
        error_log("DEBUG UPDATE - NÃºmero de archivos: " . count($_FILES['archivos']['name']));

        for ($i = 0; $i < count($_FILES['archivos']['name']); $i++) {

            error_log("DEBUG UPDATE - Archivo $i: Nombre='" . $_FILES['archivos']['name'][$i] . "', TamaÃ±o=" . $_FILES['archivos']['size'][$i] . ", Error=" . $_FILES['archivos']['error'][$i] . ", Temp='" . $_FILES['archivos']['tmp_name'][$i] . "'");

        }

    } else {

        error_log("DEBUG UPDATE - No se encontrÃ³ el campo 'archivos' en FILES");
...
WHERE id_solicitud = '$id_solicitud'";
    ...
    if ($mysqli->query($query)) {
        ...
        // 2. Insertar todos los vehÃ­culos que vienen del formulario
        ...
        for ($i = 0; $i < count($tipos); $i++) {
            ...
            $modelo = intval($modelos[$i]); // modelo es numÃ©rico
            ...
            // Solo insertar si algÃºn campo obligatorio no estÃ¡ vacÃ­o (ejemplo placa o tipo)
        ...
        for ($i = 0; $i < count($tipos); $i++) {
            ...
            // Validar que al menos un campo obligatorio no estÃ© vacÃ­o (ej. tipo o direcciÃ³n)
        ...
        $uploadDir = __DIR__ . '/documentos/'; // Carpeta 'documentos' en la misma ubicaciÃ³n del script
        ...
        // InformaciÃ³n de debug sobre lÃ­mites de PHP
        ...
        error_log("DEBUG UPDATE - LÃ­mites PHP: upload_max_filesize=$maxFileSize, post_max_size=$maxPostSize, max_input_time=$maxInputTime, memory_limit=$memoryLimit");
        ...
        if (isset($_FILES['archivos']) && is_array($_FILES['archivos']['error'])) {
            ...
            // Caso cuando no se envÃ­an archivos o el campo estÃ¡ vacÃ­o
        ...
        // FunciÃ³n para convertir cÃ³digos de error en mensajes legibles
        ...
        function getUploadErrorMessage($errorCode) {
            ...
            switch ($errorCode) {
                ...
                case UPLOAD_ERR_EXTENSION:
                    ...
                    return 'Una extensiÃ³n de PHP detuvo la subida';
            ...
            foreach ($_FILES['archivos']['name'] as $index => $fileName) {
                ...
                if ($uploadError === UPLOAD_ERR_OK) {
                    ...
                    // Crear nombre con cÃ©dula, fecha y nombre original
                    ...
                    if (!is_uploaded_file($tmpName)) {
                        ...
                        $erroresArchivos[] = "Archivo $fileName: No es un archivo subido vÃ¡lido";
                    ...
                    if ($fileSize <= 0) {
                        ...
                        $erroresArchivos[] = "Archivo $fileName: TamaÃ±o de archivo invÃ¡lido ($fileSize bytes)";
                    ...
                    if (move_uploaded_file($tmpName, $destination)) {
                        ...
                        error_log("Ã‰XITO UPDATE - Archivo movido: $originalName");
                        ...
                        if (file_exists($destination)) {
                            ...
                            $tamaÃ±o = filesize($destination);

                            error_log("CONFIRMADO UPDATE - Archivo existe: $destination (TamaÃ±o: $tamaÃ±o bytes)");

                        } else {

                            $erroresArchivos[] = "Archivo $fileName: Se moviÃ³ pero no existe en destino";
            ...
            error_log("INFO UPDATE - Usuario no subiÃ³ archivos nuevos, continuando sin archivos");
        ...
        if (empty($mensajeArchivos)) {
            ...
            $mensajeArchivos = "ActualizaciÃ³n exitosa (sin archivos nuevos)";
