...
// Configurar lÃ­mites para manejo de archivos
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($mysqli->query($query)) {
    ...
    }    // InformaciÃ³n bÃ¡sica sobre lÃ­mites de PHP (solo log crÃ­tico)
    ...
    if (isset($_FILES['archivos']) && is_array($_FILES['archivos']['error'])) {
        ...
        if (isset($_FILES['archivos']) && $_FILES['archivos']['error'][0] === UPLOAD_ERR_NO_FILE) {
            ...
            // Usuario no seleccionÃ³ archivos - comportamiento normal
    ...
    if ($hayArchivos) {
      ...
      foreach ($_FILES['archivos']['name'] as $index => $fileName) {
        ...
        $tmpName = $_FILES['archivos']['tmp_name'][$index];
          ...
          if (move_uploaded_file($tmpName, $destination)) {
              ...
              if (!file_exists($destination)) {
                  ...
                  $erroresArchivos[] = "Archivo $fileName: Error en la verificaciÃ³n final";

              }

          } else {

              $erroresArchivos[] = "Archivo $fileName: Error al mover archivo";
        ...
        // Usuario no subiÃ³ archivos, continuando sin archivos
    ...
    if (!empty($erroresArchivos)) {
        ...
        // Filtrar errores que no sean crÃ­ticos
  ...
  <body>
    ...
    <script>
      ...
      Swal.fire({
        ...
        text: 'OcurriÃ³ un error al guardar la solicitud.',
