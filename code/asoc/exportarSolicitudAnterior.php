...
// Consultar vehÃ­culos relacionados (usando columnas que existen en la tabla)
...
// Obtener datos de inmuebles y vehÃ­culos
...
// Definir los datos segÃºn tu especificaciÃ³n
...
$datos = [
    ...
    cleanNumericValue($datos_solicitud['monto_sol'] ?? ''),

    $datos_solicitud['plazo_sol'] ?? '',
    ...
    cleanNumericValue($datos_solicitud['salario_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['ing_arri_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['honorarios_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['pension_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['otros_ing_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['cuota_pres_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['cuota_tar_cred_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['arrendo_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['gastos_fam_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['otros_gastos_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['ahorro_banco_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['vehiculo_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['bienes_raices_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['otros_activos_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['presta_total_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['hipotecas_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['tar_cred_total_sol'] ?? ''),

    cleanNumericValue($datos_solicitud['otros_pasivos_sol'] ?? ''),

    $datos_solicitud['tipo_inmu_1_sol'] ?? (isset($inmuebles[0]) ? $inmuebles[0]['tipo'] : ''),

    $datos_solicitud['direccion_1_sol'] ?? (isset($inmuebles[0]) ? $inmuebles[0]['direccion'] : ''),

    cleanNumericValue($datos_solicitud['valor_comer_1_sol'] ?? (isset($inmuebles[0]) ? $inmuebles[0]['valor_comercial'] : '')),

    $datos_solicitud['tipo_inmu_2_sol'] ?? (isset($inmuebles[1]) ? $inmuebles[1]['tipo'] : ''),

    $datos_solicitud['direccion_2_sol'] ?? (isset($inmuebles[1]) ? $inmuebles[1]['direccion'] : ''),

    cleanNumericValue($datos_solicitud['valor_comer_2_sol'] ?? (isset($inmuebles[1]) ? $inmuebles[1]['valor_comercial'] : '')),

    $datos_solicitud['tipo_vehi_1_sol'] ?? (isset($vehiculos[0]) ? $vehiculos[0]['tipo'] : ''),

    $datos_solicitud['modelo_1_sol'] ?? (isset($vehiculos[0]) ? $vehiculos[0]['modelo'] : ''),

    $datos_solicitud['marca_1_sol'] ?? (isset($vehiculos[0]) ? $vehiculos[0]['marca'] : ''),

    $datos_solicitud['placa_1_sol'] ?? (isset($vehiculos[0]) ? $vehiculos[0]['placa'] : ''),

    cleanNumericValue($datos_solicitud['valor_1_sol'] ?? (isset($vehiculos[0]) ? $vehiculos[0]['valor_comercial'] : '')),

    $datos_solicitud['tipo_vehi_2_sol'] ?? (isset($vehiculos[1]) ? $vehiculos[1]['tipo'] : ''),

    $datos_solicitud['modelo_2_sol'] ?? (isset($vehiculos[1]) ? $vehiculos[1]['modelo'] : ''),

    $datos_solicitud['marca_2_sol'] ?? (isset($vehiculos[1]) ? $vehiculos[1]['marca'] : ''),

    $datos_solicitud['placa_2_sol'] ?? (isset($vehiculos[1]) ? $vehiculos[1]['placa'] : ''),

    cleanNumericValue($datos_solicitud['valor_2_sol'] ?? (isset($vehiculos[1]) ? $vehiculos[1]['valor_comercial'] : '')),

    $datos_solicitud['ahorros_sol'] ?? '',

    cleanNumericValue($datos_solicitud['valor_ahor_sol'] ?? ''),

    $datos_solicitud['enseres_sol'] ?? '',

    cleanNumericValue($datos_solicitud['valor_enser_sol'] ?? ''),
    ...
    cleanNumericValue($datos_solicitud['conyu_salario_sol'] ?? ''),
    ...
    cleanNumericValue($datos_solicitud['otros_ahorros_sol'] ?? '')
