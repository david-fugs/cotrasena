            ...
            <div class="seccion">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="pais_exp_cedula_aso" class="form-control" required>
                    </div>
                    <div class="col-md-3">
                        <label for="dpto_exp_cedula_aso" class="form-label">Departamento expedición</label>
                        <input type="text" name="dpto_exp_cedula_aso" class="form-control" required>
                    </div>
                    <div class="col-md-3">
                        <label for="ciudad_exp_cedula_aso" class="form-label">Ciudad expedición</label>
                        <input type="text" name="ciudad_exp_cedula_aso" class="form-control" required>
                    </div>
                </div>
