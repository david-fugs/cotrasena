...
// Verifica si se recibe el id_solicitud por GET
if (!isset($_GET['id_solicitud'])) {
    echo "<p class='text-danger'>No se especificó una solicitud para editar.</p>";
    exit();
}
...
<body>
    <div class="container" style="margin-bottom: 50px;">
        ...
        <br />
        <h1><b><i class="fa-regular fa-credit-card"></i> EDITAR SOLICITUD DE CRÉDITO</b></h1>
        <p><i><b>
