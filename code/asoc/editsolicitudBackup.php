...
<div>
    ...
    <header class="header">
        ...
        <h1 class="title">EDITAR SOLICITUD DE CRÃ‰DITO</h1>
    ...
    <div class="container" id="container">
        ...
        <form action='updateSolicitud.php' method="POST" enctype="multipart/form-data">
            ...
            <div class="seccion">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-3 mt-2">
                        ...
                        <label for="anti_emp_mes_sol">* AntigÃ¼edad en Meses</label>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-3 mt-2">
                        ...
                        <label for="area_trabajo_sol">* Ãrea de Trabajo</label>
            ...
            <div class="seccion">
                ...
                <h3 class="subtitulo">RELACIÃ“N INMUEBLES</h3>
                            ...
                            <div class="form-group inmueble-item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4 mt-2">
                                        ...
                                        <label for="direccion_<?= $index ?>">DirecciÃ³n <?= $index + 1 ?></label>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-3 mt-2">
                        ...
                        <select name="fami_parent_1_sol" class="form-control" id="fami_parent_1_sol">
                            ...
                            <option value="CUÃ‘ADO" <?php echo ($datos_solicitud['fami_parent_1_sol'] == 'CUÃ‘ADO') ? 'selected' : ''; ?>>CUÃ‘ADO (A)</option>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-3 mt-2">
                        ...
                        <select name="fami_parent_2_sol" class="form-control" id="fami_parent_2_sol">
                            ...
                            <option value="CUÃ‘ADO" <?php echo ($datos_solicitud['fami_parent_2_sol'] == 'CUÃ‘ADO') ? 'selected' : ''; ?>>CUÃ‘ADO (A)</option>
                                ...
                                <div class="alert alert-secondary d-flex justify-content-between align-items-center py-2 px-3 mb-2">
                                    ...
                                    <div>
                                        ...
                                        <a href="eliminar_documento.php?archivo=<?= urlencode($archivo) ?>&id_solicitud=<?= urlencode($id_solicitud) ?>"
                                            ...
                                            onclick="return confirm('Â¿EstÃ¡s seguro de que deseas eliminar este documento?');">
    ...
    <script>
        ...
        fileInput.addEventListener('change', (event) => {
            ...
            if (selectedFiles.length > 3) {
                ...
                fileInput.value = ''; // Borra la selecciÃ³n si son mÃ¡s de 3
