...
<body>
   	...
   	<?php
	    ...
	    if(isset($_POST['btn-update']))
        {
            ...
            $catg_pro           =   mb_strtoupper($_POST['catg_pro']);
            $fecha_pro          =   $_POST['fecha_pro'];
            $fecha_edit_pro     =   date('Y-m-d h:i:s');
            $id_usu_edit        =   $_SESSION['id_usu'];
           
            $update = "UPDATE productos SET nom_pro='".$nom_pro."', precio_prod='".$precio_prod."', catg_pro='".$catg_pro."', fecha_pro='".$fecha_pro."', fecha_edit_pro='".$fecha_edit_pro."', id_usu_edit='".$id_usu."' WHERE cod_pro='".$cod_pro."'";
